        ...
        <div class="row">
                ...
                <div class="box">
                    <div class="card mb-3">
                        <div class="card-header">
                            <a href="">Pendaftaran Siswa Baru Tahun Pelajaran Akademik 2022/2023 Telah Dibuka</a>
                        </div>
                        <div class="card-body">
                            <h5 class="card-title">Penerimaan Siswa Baru Secara Online</h5>
            ...
            <div class="col-md-4">
                <div class="box">
                    ...
                    <ul>
                        <li> <a href="">Pendaftaran Siswa Baru Tahun Pelajaran Akademik 2022/2023 Telah Dibuka</a></li>
