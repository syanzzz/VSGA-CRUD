            ...
            <div class="col-md-8">
                <div class="box">
                    <form class="well shadow-sm" action="registrasi_act.php" method="POST">
                        ...
                        <button type="submit" class="btn btn-success bi bi-box-arrow-in-right"> Daftar</button>
                        <a href="index.php" class="btn btn-danger bi bi-arrow-repeat"> Batal</a>
                        <a href="daftar_siswa.php" class="btn btn-primary bi bi-info-circle"> Lihat Daftar Siswa</a>
                    </form>
                </div>
            </div>
            <div class="col-md-4">
